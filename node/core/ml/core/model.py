...
from ml.config import MODEL_META_DATA as model_meta
from maxfw.model import MAXModelWrapper
from ml.config import DEFAULT_EMBEDDING_CHECKPOINT, DEFAULT_PCA_PARAMS, DEFAULT_CLASSIFIER_MODEL
import os
...
class ModelWrapper(MAXModelWrapper):
    ...
    def __init__(self, embedding_checkpoint=DEFAULT_EMBEDDING_CHECKPOINT, pca_params=DEFAULT_PCA_PARAMS,
        ...
        # Metadata
        fname = os.path.join("ml","assets","class_labels_indices.csv")
